    ...
    <div className="p-4 md:p-6 max-w-2xl space-y-6">
      ...
      <Card>
        ...
        <CardContent className="flex flex-col sm:flex-row gap-3">
          <Button variant="outline" className="gap-2 w-full sm:w-auto min-h-[44px]" onClick={() => exportMembersToCsv(members)} disabled={isLoading}>
            <Download className="h-4 w-4" /> CSV
          </Button>
          <Button variant="outline" className="gap-2 w-full sm:w-auto min-h-[44px]" onClick={() => exportMembersToExcel(members)} disabled={isLoading}>
