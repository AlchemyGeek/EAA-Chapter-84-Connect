...
export default function MemberHome() {
  ...
  const proxyWindowOpen = new Date() < new Date("2026-07-01T00:00:00");
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-2xl mx-auto px-4 -mt-4 pb-8 space-y-4">
            ...
            <div className="rounded-lg border border-amber-300 bg-amber-50 dark:bg-amber-950/30 dark:border-amber-700 p-4 flex flex-col sm:flex-row sm:items-center gap-3">
              ...
              <div className="flex-1 space-y-1">
                ...
                <p className="text-xs text-amber-800/80 dark:text-amber-300/80">
                  Proxy form available through July 1, 2026.{proxySigned ? " ✅ Proxy signed." : ""}
                </p>
                {!inGoodStanding && (
          ...
          <CardContent className="space-y-1">
            {isRestricted ? (
              ...
              <>
                ...
                <AdminLink to={impersonateKeyId ? `/hangar-talk?viewAs=${impersonateKeyId}` : "/hangar-talk"} icon={MessageSquare} label={`Hangar Talk${hangarTalkUnread > 0 ? ` (${hangarTalkUnread})` : ""}`} />
        ...
        <p className="text-center text-xs text-muted-foreground pt-4">v26.06.03</p>
      </div>
